...
INSERT INTO "tbl_kategori_item" ("nm_kitem", "detail") VALUES
('Tidak Ada',	'Item peta yang tidak berkategori ditampilkan dikategori ini'),
('Wilayah Sumatera Selatan',	'Wilayah sumsel');
